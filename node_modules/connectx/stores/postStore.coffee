...
markPostFailed = (action) ->
  post = @get action.clientId
  post.failed = true
  post.pending = false
  @set action.clientId, post
...
# TODO: make the pending post stuff use cache/queue instead of just clientId
class PostStore extends BaseStore
  ...
  getByAuthorId: (id) -> @query (post) -> post.author.id is id
