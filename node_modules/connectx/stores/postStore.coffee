...
class PostStore extends BaseStore
  ...
  getByAuthorId: (id) -> (@query (post) -> post.author.id is id).sort((a, b) -> a.createdAt > b.createdAt).reverse()
  getByOwnerId: (id) -> (@query (post) -> post.owner.id is id).sort((a, b) -> a.createdAt > b.createdAt).reverse()
  handlers: [
