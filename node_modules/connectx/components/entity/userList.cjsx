...
UserRequestView = React.createClass
  ...
  render: ->
    <li className= "grid-100 bg-lv-1 bs-lv-1 brad-5-px ptb-3 ">
      <Link to="user" params={id: @props.id}>
        <h3 className ="grid-40 c-green lh-4 brad-5-px bs-lv-1 va-c ">Name: {@props.name} (Request)</h3>
        <button className="grid-20 c-white connect_btn green brad-5-px bg-green">Accept</button>
