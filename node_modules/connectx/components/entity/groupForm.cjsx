...
GroupForm = React.createClass
  ...
  getInitialState: -> name: '', description: '', location: '', city: '', state: '', zip: ''
  formFields:
    name:
      label: 'Name'
      required: true
      ...
      <div className="modal_body">
        <form>
          ...
          <div className="modalForm clearfix">
            ...
            <p className="col1 modal_section">
              <span>
                <label htmlFor="location">Location of Group</label>
                <input name="location" ref="location" value={@state.location} onChange={@onFormChange} placeholder="" type="text" />
              </span>
            </p>
            ...
            <p className="btn_group modal_section">
              ...
              <button className="cancel" onClick={@props.onRequestHide}>Cancel</button>
            </p>
          </div>
        </form>
      </div>
