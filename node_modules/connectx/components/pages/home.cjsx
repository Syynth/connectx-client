      ...
      <div className="home_wrapper shadow">
        ...
        <main>
          ...
          <section className="about">
            ...
            <iframe className="partition home-vid" allowFullscreen="true" frameborder="0" height="264" webkitallowfullscreen="true" width="450" src="http://player.vimeo.com/video/75112407"/>
          </section>
          {midSection}
