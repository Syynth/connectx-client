...
SessionControls = require 'connectx/components/sessionControls'
...
HomeNav = module.exports = React.createClass
  render: ->
    ...
    <section className="partition nav">
      <SessionControls isLoggedIn={@props.isLoggedIn} />
      <ul className="buttonRow navbar">
        ...
        <li className={unless @props.isLoggedIn then "corners_left" else ""}>
          <Link to="home">
