...
Connectx = require 'connectx/components/connectx'
  ...
  render: ->
    <div>
      ...
      <section className="ch_name_wrapper">
        <p className="clubhouse_name">{@props.entity.name + "'s Clubhouse"}</p>
      </section>
      <section className="sub_roof">
        <section className="cover_img">
          <figure className="cover-fig">
            <Connectx {...@props} text="Add friend" />
            <img className="cover-img" src={@getCoverPhoto @props.entity}/>
          </figure>
        </section>
        <div className="pic">
          <figure className="overlay">
            <img className="profile_img" src={@getProfilePhoto @props.entity} />
          </figure>
        </div>
      </section>
