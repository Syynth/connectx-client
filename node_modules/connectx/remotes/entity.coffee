...
{stubs, token, ok} = require './helpers'
_ = require 'lodash'
guid = require 'guid'
Q = require 'q'
...
module.exports =
  ...
  fetchEntity: (id, type, cb) ->
    ...
    req.get "#{ApiUrl}/entity/#{type}/#{id}"
      ...
      .end (err, res) ->
        # replace err with res.body.message
        return deferred.reject {id, type}, err if err or res.statusType isnt 2
  ...
  putEntity: (entity, cb) ->
    ...
    req.put "#{ApiUrl}/entity/#{entity.type}/#{entity.id}"
      ...
      .send entity
      .end (err, res) ->
        return deferred.reject entity, err if err or res.statusType isnt 2
        deferred.resolve _.extend {}, res.body
  ...
  searchEntityByName: (type, name, cb) ->
    ...
    req.get "#{ApiUrl}/entities/#{type}/#{name}"
      .set 'CONNECTX-AUTH', token()
      .end (err, res) ->
